    ...
    extends AbstractMavenReport
{
    ...
    private static final String[] IMAGE_FILES =
        { "canoo.gif", "collapseall.png", "expandall.png", "expandMinus.png", "expandPlus.png", "favicon.ico",
            "failed.gif", "less.gif", "more.gif", "ok.gif", "optional.gif", "todo.gif", "webtest.jpg" };

    /**
     * List of web resources copied to the webreport directory
     */
    private static final String[] WEB_RESOURCE_FILES =
        { "report.css", "responseBrowser.html", "responseBrowser.js", "responseBrowserCommands.html",
            "responseBrowserPreviews.html", "showHide.js", "sorttable.js" };
     ...
     */
    private void createReportResources()
        throws Exception
    {
     ...
     */
    private void createHtmlSingleTestReport()
        throws Exception
    {
     ...
     * @throws Exception creating the HTML report failed
     */
    private void createXmlWebTestSummary()
        throws Exception
    {
        ReportCollector walker;
        File[] xmlReportList;
     ...
     * @throws Exception creating the HTML report failed
     */
    private void createHtmlWebTestOverview()
        throws Exception
    {
     ...
     * @throws Exception creating the HTML report failed
     */
    private void createXmlWebTestOverview()
        throws Exception
    {
        ReportCollector walker;
     ...
     */
    private void copyHtmlResponses()
        throws Exception
    {
