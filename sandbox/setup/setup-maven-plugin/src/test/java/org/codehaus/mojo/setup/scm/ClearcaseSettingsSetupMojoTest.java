    ...
    extends AbstractScmSettingsSetupMojoTest
{
    ...
    {
        Settings settings = ClearCaseUtil.readSettings();
    ...
    {
        Settings settings = ClearCaseUtil.readSettings();
        assertEquals( "changelogUserFormat_åäöéèü", settings.getChangelogUserFormat() );
        assertEquals( "clearcaseType_åäöéèü", settings.getClearcaseType() );
        assertEquals( "viewstore_åäöéèü", settings.getViewstore() );
    }
