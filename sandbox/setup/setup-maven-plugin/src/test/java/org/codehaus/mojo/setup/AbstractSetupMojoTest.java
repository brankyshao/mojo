    ...
    extends AbstractMojoTestCase
{
    ...
    protected String getNonUTF8EncodedTemplateFileArgument()
    {
        return getTemplateBase() + "-nonutf8.xml";
    }
    ...
    public void testFromNonUTF8Encoding()
        throws Exception
    {
        File currentTestWorkDirectory = new File( getWorkDirectory(), getTestPrefix() + "-fromNonUTF8Encoding" );
        prepareDirectoryStructure( getDirectoryMissingTargetFile(), currentTestWorkDirectory );
        prepareMojo( currentTestWorkDirectory );

        setVariableValueToObject( getMojo(), PROPERTY_SETTINGSFILE, getNonUTF8EncodedTemplateFileArgument() );

        File sourceFile = new File( "src/test/resources/basefolder", getNonUTF8EncodedTemplateFileArgument() );
        FileUtils.copyFileToDirectory( sourceFile, currentTestWorkDirectory );
        ...
        validateAsNonUTF8EncodedTemplate();
    }
    ...
    protected abstract void validateAsNonUTF8EncodedTemplate()
        throws Exception;
