    ...
    implements SetupManager, LogEnabled
{
        ...
        throws SetupExecutionException
    {
        ...
        {
            getLog().debug( "Target file path: " + targetReadFile.getPath() );
        }
        ...
        throws SetupExecutionException
    {
        ...
        try
        {
            ...
            String encoding = ReaderFactory.newXmlReader( request.getTemplateFile() ).getEncoding();
            getLog().debug( "Encoding used for copying/filtering: " + encoding );
            FileUtils.copyFile( request.getTemplateFile(), result, encoding,
